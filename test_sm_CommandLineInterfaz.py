...
class CommandLineInterfazTest(test_sm_TestSuper.TestSMSuper):
	...
	if (CommandLineInterfazTest.test_defaultmode(self)):
		print "  - Running CommandLineInterfazTest.test_defaultmode: Ok"
	if (CommandLineInterfazTest.test_portSpecificationB(self)):
		print "  - Running CommandLineInterfazTest.test_portSpecificationB: Ok"
	if (CommandLineInterfazTest.test_portSpecificationA(self)):
		print "  - CommandLineInterfazTest.test_portSpecificationA: Ok"
